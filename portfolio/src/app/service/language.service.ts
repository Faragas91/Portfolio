...
export class LanguageService {
  ...
  translations: {[key: string]: { [key:string]: string}} = {
    en: {
      ...
      privacyPolicy: `I've read the <a href="/privacy-policy" target="_blank">privacy policy</a> and agree to the processing of my data as outlined`,
      sayHello: 'Say Hello ;)',
    ...
    de: {
      ...
      privacyPolicy: `Ich habe die <a href="" target="_blank">Datenschutzerklärung</a>  gelesen und stimme zu, dass meine Daten verarbeitet werden, wie beschrieben`,
