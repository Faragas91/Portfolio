...
export class LanguageService {
  ...
  translations: {[key: string]: { [key:string]: string}} = {
    en: {
      ...
      aboutMeMainText: 'a passionate web developer with a focus on modern frontend technologies. I develop intuitive and perfomant user interfaces with for example Angular, TypeScript and SCSS. My strengths lie in structured code, well thought-out UI/UX design and the ambition to make every application not only functional but also visually appealing. What motivates me? The combination of creativity and logic. I love solving problems elegantly and bringing ideas to life digitally. In recent years, I have worked on a wide range of projects - from small to complex web applications. I value clean code, teamwork and continuous learning',
    ...
    de: {
      ...
      aboutMeMainText: 'ein leidenschaftlicher Webentwickler mit Fokus auf moderene Frontend-Technologien. Ich entwickle intuitive und perfomante Benutzeroberflächen mit zum Beispiel Angular, TypeScript und SCSS. Meine Stärken liegen in strukturiertem Code, durchdachtem UI/UX-Design und dem Anspruch, jede Anwendung nicht nur funktional, sondern auch optisch anprechend zu gestalten. Was mich motiviert? Die Verbindung von Kreativität und Logik. Ich liebe es, Probleme elegant zu lösen und Ideen digital zum Leben zu erwecken. In den letzten Jahren habe ich an vielseitigen Projekten gearbeitet - von kleinen bis zu komplexen Webanwendungen. Dabei lege ich Wert auf sauberen Code, Teamarbeit und kontinuierliches Lernen',
