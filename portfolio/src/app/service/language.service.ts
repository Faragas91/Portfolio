...
export class LanguageService {
  ...
  translations: {[key: string]: { [key:string]: string}} = {
    en: {
      ...
      aboutMeText: 'A passionate web developer with a focus on modern front-end technologies such as Angular, TypeScript and SCSS.  What excites me about programming is the combination of logic, creativity and structure. I love analyzing problems, finding elegant solutions and translating them into user-friendly interfaces. I am particularly motivated by the moment when a complex problem becomes a clear, functioning feature.  I like to work in a structured and solution-oriented way. I see challenges as a learning opportunity - I analyze, experiment and improve my approach until I find an efficient solution. To expand my skills, I rely on continuous learning: through my own projects, online resources, exchanges with other developers or following current trends and best practices.Qualities such as analytical thinking, creativity, teamwork and perseverance help me to think my way into complex tasks and implement them successfully. My goal is to write not only functional, but also aesthetically pleasing and maintainable code - and to constantly develop myself in the process.',
    ...
    de: {
      ...
      aboutMeText: 'Ein leidenschaftlicher Webentwickler mit Fokus auf moderne Frontend-Technologien wie Angular, TypeScript und SCSS.  Was mich am Programmieren begeistert, ist die Kombination aus Logik, Kreativität und Struktur. Ich liebe es, Probleme zu analysieren, elegante Lösungen zu finden und diese in nutzerfreundliche Interfaces zu übersetzen. Dabei motiviert mich besonders der Moment, in dem ein komplexes Problem zu einem klaren, funktionierenden Feature wird.  Ich arbeite gerne strukturiert und lösungsorientiert. Herausforderungen sehe ich als Lernchance – ich analysiere, experimentiere und verbessere meinen Ansatz, bis ich eine effiziente Lösung finde.  Um meine Fähigkeiten zu erweitern, setze ich auf kontinuierliches Lernen: durch eigene Projekte, Online-Ressourcen, Austausch mit anderen Entwickler:innen oder das Verfolgen aktueller Trends und Best Practices.  Eigenschaften wie analytisches Denken, Kreativität, Teamfähigkeit und Ausdauer helfen mir, mich in komplexe Aufgaben hineinzudenken und sie erfolgreich umzusetzen. Mein Ziel ist es, nicht nur funktionalen, sondern auch ästhetisch ansprechenden und wartbaren Code zu schreiben – und mich dabei ständig weiterzuentwickeln.',
