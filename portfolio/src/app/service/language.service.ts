...
export class LanguageService {
  ...
  translations: {[key: string]: { [key:string]: string}} = {
    en: {
      ...
      aboutMeFirstSection: 'a passionate web developer with a focus on modern frontend technologies.',
      aboutMeSecondSection: 'I develop intuitive and perfomant user interfaces with for example Angular, TypeScript and SCSS. My strengths lie in structured code, well thought-out UI/UX design and the ambition to make every application not only functional but also visually appealing.',
      aboutMeThirdSection: 'What motivates me? The combination of creativity and logic. I love solving problems elegantly and bringing ideas to life digitally.',
      aboutMeFourthSection: 'Over the past months and years, I have worked on a wide range of projects - from small to complex web applications. What I value most is writing clean and readable code, teamwork and constant learning to broaden my horizons.',
    ...
    de: {
      ...
      aboutMeFirstSection: 'ein leidenschaftlicher Webentwickler mit Fokus auf moderene Frontend-Technologien.',
      aboutMeSecondSection: 'Ich entwickle intuitive und perfomante Benutzeroberflächen mit zum Beispiel Angular, TypeScript und SCSS. Meine Stärken liegen in strukturiertem Code, durchdachtem UI/UX-Design und dem Anspruch, jede Anwendung nicht nur funktional, sondern auch optisch anprechend zu gestalten.',
      aboutMeThirdSection: 'Was mich motiviert? Die Verbindung von Kreativität und Logik. Ich liebe es, Probleme elegant zu lösen und Ideen digital zum Leben zu erwecken.',
      aboutMeFourthSection: 'In den letzten Monaten und Jahren habe ich an einem breiten Spektrum von Projekten gearbeitet - von kleinen bis hin zu komplexen Webanwendungen. Worauf ich am meisten Wert lege sind einen sauberen und gut leserlichen Code zu schreiben, Teamarbeit und ein stetiges Lernen um meinen Horizont zu erweitern.',
