...
export class LanguageService {
  ...
  translations: {[key: string]: { [key:string]: string}} = {
    en: {
      ...
      contactDescriptionFirstSection: "As a frontend developer, I am passionate about developing user-friendly, modern and aesthetically pleasing web applications that work optimally on both desktop and mobile devices.",
      contactDescriptionSecondSection: "My focus is on adding real value to your project through clean and maintainable code and creative UI solutions. I want to bring your ideas to life and delight your users with an intuitive and performant user interface.",
    ...
    de: {
      ...
      contactDescriptionFirstSection: "Als Frontend Developer begeistere ich mich dafür, benutzerfreundliche, moderne und ästhetisch ansprechende Webanwendungen zu entwickeln, die sowohl auf Desktop- als auch auf mobilen Geräten optimal funktionieren.",
      contactDescriptionSecondSection: "Mein Fokus liegt darauf, durch sauberen und wartbaren Code sowie durch kreative UI-Lösungen echten Mehrwert für Ihr Projekt zu schaffen. Ich möchte Ihre Ideen zum Leben erwecken und Ihre Nutzer mit einer intuitiven und performanten Benutzeroberfläche begeistern.",
